...
type
  ...
  private
    SFTP: TSFTPClient;
    procedure FillList;
    procedure OnProgress(ASender: TObject; const AFileName: String; ATransfered, ATotal: UInt64);
...
procedure TForm3.OnProgress(ASender: TObject; const AFileName: String; ATransfered, ATotal: UInt64);
begin
  //
